...
const AnnouncementsTeacher: React.FC = () => {
  ...
  const fetchAnnouncements = async () => {
    try {
      ...
      // Teachers see only visible announcements, sorted by newest first
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen overflow-x-hidden">
      ...
      {loading ? (
        ...
        // SINGLE-COLUMN layout (one card per row), matching the admin/student style
          ...
          {announcements.map((announcement) => (
            ...
            >
              ...
              <div className="mt-4 flex-1 overflow-auto">
                ...
                {/* Row with Publish Date, Expiry, Created By */}
